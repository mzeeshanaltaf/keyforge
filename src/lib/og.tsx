...
/**
 * Shared Open Graph / Twitter card renderer (1200x630). Used by the root
 * `opengraph-image.tsx` and by each tool route's own image so shared links
 * unfurl with the specific tool name instead of the homepage headline.
 */
